...
<TABLE border='0' width='600'>
	<TR>
		<td align='left'>
			<a href="modify_pass3.jsp?num=<%=no %>">[수정하기]</a>
			<a href="delete_pass3.jsp?num=<%=no %>">[삭제하기]</a>
		</td>
		
		<TD align='right'>
			<a href='write3.jsp'>[글쓰기]</a>
			<a href='listboard3.jsp'>[목록보기]</a>
 		</TD>
	</TR>
</TABLE>
<%
strSQL = "UPDATE gm3 SET count=count+1 WHERE no = ?";
pstmt = conn.prepareStatement(strSQL);
pstmt.setInt(1, Integer.parseInt(no));
pstmt.executeUpdate();
