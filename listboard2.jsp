...
<body>
	...
	String strSQL = "SELECT * FROM gm2 ORDER BY no DESC";
	...
	<center>
		...
		<table bgcolor=282828 width='600'cellpadding=3 cellspacing=3>
			<tr>
				<td align="center"><font color='ffffff' size='5'><b> ㄴㄴ게시판 </b></font>
				</td>
			</tr>
		</table>
		...
		<TABLE bgcolor='282828'  border=0 width=600 cellpadding=5 cellspacing=0>
			<tr>
				<td align=left></td>
				<TD align='right'><a href='write2.jsp'>[등록] &nbsp; </a></TD>
			</TR>
		</TABLE>
		<TABLE bgcolor='282828'  border='0' width='600' cellpadding='0' cellspacing='0'>
			<TR>
		...
		<TABLE bgcolor='282828'  border='0' cellspacing=1 cellpadding=2 width='600'>
			...
			<%
			if (lastRow > 0) {
				strSQL = "select * from gm2 where no between " + startRow + " and " + endRow;
			...
			<TR bgcolor='ededed'>
				...
				<TD align=left><a href="write_output2.jsp?no=<%=listno%>">
		...
		if (currentPage > 1) {
		%>
		<a href="listboard2.jsp?pageno=<%=currentPage - 1%>">[이전]</a>
		<%
		}
		while (setPage <= lastPage) {
		%>
		<a href="listboard2.jsp?pageno=<%=setPage%>">[<%=setPage%>]
		</a>
		<%
		setPage = setPage + 1;
		}
		...
		%>
		<a href="listboard2.jsp?pageno=<%=currentPage + 1%>">[다음]</a>
		<%
		}
		}
		%>
